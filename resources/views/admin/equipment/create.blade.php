...
@section('header', 'Tambah Equipment Baru')
    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header bg-white">
                <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Form Tambah Equipment</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.equipment.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Nama Equipment <span class="text-danger">*</span></label>
